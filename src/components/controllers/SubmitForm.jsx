...
const Contact = () => {
    ...
    return (
        <>
            <Container className="bg-white py-20  mt-20 lg:py-[120px] overflow-hidden relative z-10 ">
                        ...
                        <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                            <div className="mb-12 max-w-[570px] lg:mb-0">
                                ...
                                <p className="text-base leading-relaxed mb-9 text-body-color">
                                    Whether you have a question to ask or a problem to solve, head
                                    to our FAQ . If you're unsure about the status of your transfer,
                        ...
                        <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
                            <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                                <form onSubmit={sendEmail}>
                                    ...
                                    />
                                    <div>
                                        <button className="px-7 py-4  w-full shadow-lg transition-all transform-gpu hover:bg-white rounded-lg text-white bg-gradient-to-r from-[#ff4501] to-[#554AE4] hover:from-[#554AE4] hover:to-[#554AE4] hover:border-gray-400 active:scale-95  hover:scale-95 active:outline-none">
                                            Send Message
                                        </button>{" "}
                                    </div>
                                </form>
                                {showSuccessMessage && (
                                    <div
                                        className="p-4 mb-4 text-sm text-center text-green-800 rounded-lg bg-green-50  dark:text-green-400"
                                        role="alert"
                                    >
                                        <span className="font-medium text-center">
                                            message set , we answer soon!
                                        </span>
                                    </div>
                                )}
    ...
    return (
        <div className="mb-6">
            <textarea
                ...
                value={value}
                onChange={onChange}
                className="border-[f0f0f0] w-full resize-none rounded border py-3 px-[14px] text-base text-body-color outline-none focus:border-purple-300 focus-visible:shadow-none"
            />
        </div>
    );
};
    ...
    return (
        <div className="mb-6">
            <input
                ...
                value={value}
                onChange={onChange}
                className="border-[f0f0f0] w-full rounded border py-3 px-[14px] text-base text-body-color outline-none focus:border-purple-300 focus-visible:shadow-none"
            />
        </div>
    );
};
